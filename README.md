...
We will review your request and, if approved, add you to the `coder-ddev-com` GitHub organization. You will receive a GitHub invitation — once you accept it, you can sign in to coder.ddev.com with your GitHub account.
